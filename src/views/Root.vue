<template>
  <div class="flex w-full h-screen" v-escape="esc">
    ...
    >
      ...
      <div
        class="modal-main bg-white w-11/12 mx-auto rounded-lg z-50 overflow-y-auto max-h-full"
      >
        <div v-if="showModal === 'step1'">
          <div class="pl-1 pr-4 py-1 h-12">
            ...
            <i
              class="flex justify-center fab fa-twitter text-blue text-2xl mt-2 mb-8"
            ></i>
          </div>
          <div class="pt-5 px-8">
            ...
            <div class="mt-5 mb-5">
              ...
              <div class="flex justify-between items-top">
                <p>
                  ...
                  activity. When this setting is enabled, Twitter may further
                  personalize ads from Twitter advertisers, on and off Twitter,
                  by combining your Twitter activity with other online activity
                  and information from partners.
                </p>
                <input class="mt-1 ml-2 mr-2" type="checkbox" />
              </div>
            </div>
        ...
        <div v-if="showModal === 'step3'">
          ...
          <div class="pt-5 px-8">
            <div class="flex justify-center items-center pb-4">
              <p class="test-2xl font-bold">You'll need a password</p>
            </div>
