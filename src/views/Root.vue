        ...
        <div v-if="showModal === 'step1'">
          <div class="pl-1 pr-4 py-1 h-12">
            <button
              ...
              class="rounded-full bg-blue text-white mt-2 p-1 pl-3 pr-3 relative right-0 float-right hover:bg-darkblue" :class="`${!name || !email || !birthdate? 'opacity-50 cursor-not-allowed': ''}`"
            >
              Next
            </button>
            <i
